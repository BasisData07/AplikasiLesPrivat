...
class _SignUpPageState extends State<SignUpPage> {
    ...
    // Hapus variabel isPasswordVisible/isConfirmPasswordVisible karena sudah ada di _FormRegistrasiState
    ...
    Future<void> _signUp() async {
        ...
        // Simpan referensi ScaffoldMessengerState
        ...
        try {
            ...
            // Tutup loading dialog (Pastikan context masih mounted sebelum pop)
            if (context.mounted) {
                Navigator.pop(context); 
            }

            // Handle result dengan aman
            if (result['success'] == true) {
                print('🎉 Registration successful, navigating to login');
                
                // Tampilkan snackbar sukses menggunakan referensi yang aman
                ...
                // Kembali ke login page (hanya jika halaman SignUp masih mounted)
                if (context.mounted) {
                    Navigator.pop(context);
                }
            } else {
            ...
            // Pastikan loading dialog ditutup bahkan jika error
            if (context.mounted) {
            ...
            body: Center(
                child: isSmallScreen
                    ? SingleChildScrollView(
                        // ✅ PERBAIKAN: Tambahkan padding untuk mobile
            ...
            children: [
                ...
                Padding(
                    ...
                    child: Text(
                        ...
                        style: isSmallScreen
                            ? Theme.of(context).textTheme.titleLarge?.copyWith( // Ganti titleMedium ke titleLarge agar lebih besar
                                    fontWeight: FontWeight.bold,
                                    color: Colors.orange,
                                    fontSize: 24, // Naikkan ukuran font
                                )
                            : Theme.of(context).textTheme.titleLarge?.copyWith( // Gunakan titleLarge juga di desktop
                                    fontWeight: FontWeight.bold,
                                    color: Colors.orange,
                                    fontSize: 32, // Naikkan ukuran font
                                ),
                    ),
                ),
                Padding(
            ...
            child: Form(
                ...
                child: Column(
                    ...
                    children: [
                        ...
                        // Hapus _gap() yang berlebihan di sini
                        // _gap(), 
                        TextButton(
